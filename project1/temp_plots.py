...
if __name__ == '__main__':
	...
	# 	h1 = plt.plot(poly_degrees, MSE_ridge_bootstrap[k],  label='MSE_test', color='orange', alpha=k*0.1)#, s=15)
	# 	h2 = plt.plot(poly_degrees, BIAS_ridge_bootstrap[k], label='BIAS',     color='blue',   alpha=k*0.1)#, s=15)
