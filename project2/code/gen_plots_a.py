...
def SGD_lr_batches(X, funcval): 
    ...
    plt.savefig("../results/figures/colormap_learningrate_batches_MSE.pdf")
    # plt.show() 
...
def SGD_ridge(X, funcval): 
    ...
    plt.savefig("../results/figures/colormap_lambda_learningrate_MSE.pdf")
    # plt.show()
...
def compare_GD_SGD_all(X, funcval): 
    ...
    plt.ylabel("MSE")
    plt.xlabel("epochs")
    plt.savefig("../results/figures/MSE_SG_SGD_learning_rates_ALL.pdf")
    # plt.show()
    print("[DONE]")
